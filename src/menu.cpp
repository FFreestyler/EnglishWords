...
void menu(RenderWindow& window)
{
    ...
    while (isMenu) {
        ...
        if (IntRect(300, 140, 150, 75).contains(Mouse::getPosition(window))) {
            MenuNum = 1;
        }
        if (IntRect(300, 260, 150, 75).contains(Mouse::getPosition(window))) {
            MenuNum = 2;
        }
        if (IntRect(300, 380, 150, 75).contains(Mouse::getPosition(window))) {
            MenuNum = 3;
        }
